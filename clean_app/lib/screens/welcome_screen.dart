            ...
            children: [
              ...
              SizedBox(
                ...
                child: OutlinedButton(
                  ...
                  child: const Text('إنشاء حساب جديد', style: TextStyle(fontSize: 20, color: Color(0xFFB46A6A))),
                  onPressed: () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => PhonePasswordRegisterScreen()),
                  ),
                ),
              ),
            ],

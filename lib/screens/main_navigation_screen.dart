            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    gradient: LinearGradient(
                      colors: [Color(0xFF6E1229), Color(0xFF5D1414)],
      ...
      try {
        showDialog(
          ...
          builder: (context) => const Center(
            child: CircularProgressIndicator(color: Color(0xFF6E1229)),
          ),
        );
            ...
            Card(
              ...
              child: ListTile(
                ...
                trailing: Switch(
                  ...
                  activeColor: const Color(0xFF6E1229),
                ),
              ),
            ),
            const SizedBox(height: 20),
    ...
    return Card(
      ...
      child: ListTile(
        leading: Container(
          ...
          child: Icon(icon, color: const Color(0xFF6E1229)),
        ),
        title: Text(
          title,

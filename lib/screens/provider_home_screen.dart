...
class _ProviderHomeScreenState extends State<ProviderHomeScreen> {
  ...
  Stream<DocumentSnapshot<Map<String, dynamic>>>? _getProviderStream() {
  ...
  Future<void> _logout() async {
    ...
    // إعادة تعيين الجلسة في Firestore
    if (userPhone != null) {
    ...
    return Scaffold(
                    ...
                    child: const Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'طلبك قيد المراجعة. لا يمكنك إعادة إرسال الطلب أثناء انتظار الموافقة.',
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.business), label: 'خدماتي'),

...
class _ProviderDashboardState extends State<ProviderDashboard> {
  ...
  Future<void> _loadProviderData() async {
    ...
    try {
      ...
      if (_providerId != null) {
        ...
        print('تم تحميل ${_items.length} عنصر');
      } else {
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              _serviceData?['serviceName'] ?? 'مزود الخدمة',
  ...
  Future<void> _addItem(Map<String, dynamic> itemData) async {
    try {
      ...
      itemData['status'] =
          'pending'; // حالة العنصر: pending في البداية حتى يوافق المالك
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      _serviceData?['providerName'] ?? 'مزود الخدمة',
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
